<template>
  <div class="checkbox-container">
    ...
    <div>
      <p>
        Default checkbox: <b>{{ defaultCheckbox }}</b>
      </p>
      <p>
        Checked checkbox: <b>{{ checkedCheckbox }}</b>
      </p>
      <p>
        Disabled checkbox: <b>{{ disabledCheckbox }}</b>
      </p>
      <p>
        Disabled Checked checkbox: <b>{{ disabledCheckedCheckbox }}</b>
      </p>
      <p>
        Long checkbox: <b>{{ longCheckbox }}</b>
      </p>
    </div>
    <v-checkbox v-model="defaultCheckbox">Default Option</v-checkbox>
    <v-checkbox v-model="checkedCheckbox">Checked Option</v-checkbox>
    <v-checkbox v-model="disabledCheckbox" :disabled="true"
      >Disabled Option</v-checkbox
    >
    <v-checkbox v-model="disabledCheckedCheckbox" :disabled="true"
      >Disabled Checked Option</v-checkbox
    >
    <v-checkbox v-model="longCheckbox">
      This is a long label for agreement with conditions of a license. Lorem
      ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
      incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis
      nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
      consequat.</v-checkbox
    >
  </div>
</template>
<script>
